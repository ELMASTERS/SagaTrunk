...
namespace Saga.Scripting
{
    public static partial class Console
    {
        ...
        public static void Position(Character character, Match match)
        {
            ...
            CommonFunctions.Broadcast(character, character, string.Format("{0} en el mapa {1}", character.Position, character.map));
        }
        ...
        {
            //Return the character's position
            string message = string.Format(CultureInfo.InvariantCulture, "{0} Personas Conectadas en IGN. ", Tasks.LifeCycle.Count);
        ...
        public static void Gmgo(Character character, Match match)
        {
            switch (Convert.ToInt16(match.Groups[1].Value))
            {
                case 1:
                    ...
                    CommonFunctions.Warp(character, map1);
                    break;
				case 3:
                    byte map3 = Convert.ToByte(3);
                    CommonFunctions.Warp(character, map3);
                    break;	
				case 5:
                    byte map5 = Convert.ToByte(5);
                    CommonFunctions.Warp(character, map5);
                    break;	
				case 13:
                    byte map13 = Convert.ToByte(13);
                    CommonFunctions.Warp(character, map13);
                    break;
				case 16:
                    byte map16 = Convert.ToByte(16);
                    CommonFunctions.Warp(character, map16);
                    break;	
				case 20:
                    byte map20 = Convert.ToByte(20);
                    CommonFunctions.Warp(character, map20);
                    break;				
                default:
					string message = string.Format(CultureInfo.InvariantCulture, "1=Hodemimes, 5=Prontera, 13=Cognito, 20=Alfheim, 16=Arena, 3=Training Grounds", Tasks.LifeCycle.Count);
					CommonFunctions.Broadcast(character, character, message);
                    break;
            }
        }
